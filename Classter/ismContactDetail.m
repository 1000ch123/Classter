...
@interface ismContactDetail ()

@end

@implementation ismContactDetail
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
		...
		self.memberDataDict = [self.ud objectForKey:@"selectedMember"];
		self.memberDataKeys = @[@"name",@"email",@"tel_no",@"notes"];
    }
    return self;
}
...
#warning Incomplete method implementation.
    ...
    return [self.memberDataKeys count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	cell.textLabel.text = self.memberDataDict[self.memberDataKeys[indexPath.row]];
